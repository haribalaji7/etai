  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-base aurora p-6 text-center space-y-6">
      <div className="relative z-10 max-w-md space-y-4">
        ...
        >
          The coordinates you requested do not point to a registered path. Check the address or return home.
        </motion.p>
        ...
        >
          <Link href="/">
            <RippleButton className="bg-accent hover:bg-accent/90 text-white font-semibold px-6 py-2.5 rounded-xl text-xs">
              Return Home
            </RippleButton>
          </Link>
        </motion.div>
